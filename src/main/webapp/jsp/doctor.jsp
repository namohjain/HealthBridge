...
<body>
	...
	<div class="wrapper rounded bg-white">
		<div class="h3">Doctor</div>
		<b><font color="red"> <%=ServletUtility.getErrorMessage(request)%>
		</font></b> <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
		</font></b>
		<hr>
		<form method="post" action="<%=EHCView.DOCTOR_CTL%>">

			<jsp:useBean id="bean" class="in.co.ehealth.care.bean.DoctorBean"
			...
			<div class="form">
				...
				<div class="row">
					...
					<div class="col-md-6 mt-md-0 mt-3">
						<label>Specialization<font color="red">*</font></label> <textarea
							 placeholder="Enter Specialization here..." name="specialization"
							class="form-control"
							><%=DataUtility.getStringData(bean.getSpecialization())%></textarea>
						<font color="red"><%=ServletUtility.getErrorMessage("specialization", request)%></font>
					</div>
				</div>
