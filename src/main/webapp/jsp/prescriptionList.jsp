<%@page import="in.co.ehealth.care.bean.PrescriptionBean"%>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item linkSize active" aria-current="page">
					<i class="fa fa-arrow-right" aria-hidden="true"></i>Prescription  List
				</li>
			</ol>
		</nav>
	</div>
	<hr>
	<form method="post" action="<%=EHCView.PRESCRIPTION_LIST_CTL%>">
		<div class="card">
			<h5 class="card-header"
				style="background-color: #00061df7; color: white;">Prescription List</h5>
			<div class="card-body">
				<div class="row g-3">
				...
				<table class="table table-bordered border-primary">
					...
					<tbody>
						...
						Iterator<PrescriptionBean> iterator = list.iterator();
						...
						<%} %>
							...
							<td scope="row"><%=bean.getDate()%></td>
								<td scope="row"><%=bean.getPrescription()%></td>
						</tr>
						<%
						}
						%>
