...
public class PatientModel {
	...
	public long add(PatientBean bean) throws ApplicationException, DuplicateRecordException {
		...
		PatientBean existbean = findByUserName(bean.getUserName());
	...
	public PatientBean findByUserName(String userName) throws ApplicationException {
		log.info("Model findByLogin Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM Patient WHERE USERNAME=?");
		...
		try {
			...
			e.printStackTrace();
			throw new ApplicationException("Exception : Exception in getting Patient by login");
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
	...
	@SuppressWarnings("unused")
	public PatientBean findByUserId(long pk) throws ApplicationException {
		log.info("Model findByPK Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM Patient WHERE UserId=?");
		PatientBean bean = null;
		Connection conn = null;
	...
	public void update(PatientBean bean) throws ApplicationException, DuplicateRecordException {
		...
		PatientBean beanExist = findByUserName(bean.getUserName());
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE F_Patient SET FIRSTNAME=?,LASTNAME=?,UserNAME=?,PASSWORD=?,CONTACTNO=?,DOB=?,Email=?,City=?,address=?,userId=?,"
	...
	public List<PatientBean> search(PatientBean bean) throws ApplicationException {
	...
	@SuppressWarnings("unused")
	public List<PatientBean> list(int pageNo, int pageSize) throws ApplicationException {
		log.info("Model list Started");
		ArrayList<PatientBean> list = new ArrayList<PatientBean>();
		StringBuffer sql = new StringBuffer("select * from Patient");
		...
		try {
			...
			throw new ApplicationException("Exception : Exception in getting list of Patient");
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
